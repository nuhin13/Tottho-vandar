...
/**
 * Created by nuhin13 on 10/3/2016.
 */
public class listFragmentFor_bd_songbidhan extends Fragment {
    ...
    public static class ContentAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        private static final int LENGTH = 69;
        ...
        public ContentAdapter(Context context) {
            ...
            mquestion = resources.getStringArray(R.array.bd_songbidhan_ques);
            manswer = resources.getStringArray(R.array.bd_songbidhan_ans);
