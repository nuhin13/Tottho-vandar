 ...
 */
public class DetailsForBanglaIQ extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //  String[] title = resources.getStringArray(R.array.titile);
        collapsingToolbar.setTitle("বাংলা আই কিউ ");
        ...
        titile_picture.setImageResource(R.drawable.i);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new ListForIQBuddhi(), "বুদ্ধি");
        adapter.addFragment(new ListForIQTest(), "আই কিউ ");
