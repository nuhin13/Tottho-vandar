...
/**
 * Created by nuhin13 on 10/2/2016.
 */
public class ListFragmentFor_Bd_muktijuddha extends Fragment {
    ...
    public static class ContentAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ContentAdapter(Context context) {
            ...
            mquestion = resources.getStringArray(R.array.bd_muktijuddho_prosno);
            manswer = resources.getStringArray(R.array.bd_muktijuddho_ans);
