 ...
 */
public class ListForHistory4 extends Fragment {
    ...
    public static class ContentAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ContentAdapter(Context context) {
            ...
            mquestion = resources.getStringArray(R.array.history_4_horror_ques);
            manswer = resources.getStringArray(R.array.history_4_horror_ans);
