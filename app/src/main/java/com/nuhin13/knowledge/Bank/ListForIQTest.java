 ...
 */
public class ListForIQTest extends Fragment {
    ...
    public static class ContentAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ContentAdapter(Context context) {
            ...
            mquestion = resources.getStringArray(R.array.iq_test_ques);
            manswer = resources.getStringArray(R.array.iqtestanswer);
