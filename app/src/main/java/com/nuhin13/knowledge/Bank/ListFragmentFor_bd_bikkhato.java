 ...
 */
public class ListFragmentFor_bd_bikkhato extends Fragment {
    ...
    public static class ContentAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ContentAdapter(Context context) {
            ...
            mquestion = resources.getStringArray(R.array.bd_bikkhato_ques);
            manswer = resources.getStringArray(R.array.bd_bikkhato_ans);
