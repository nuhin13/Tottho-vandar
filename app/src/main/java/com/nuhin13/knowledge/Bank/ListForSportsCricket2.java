 ...
 */
public class ListForSportsCricket2 extends Fragment {
    ...
    public static class ContentAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ContentAdapter(Context context) {
            ...
            mquestion = resources.getStringArray(R.array.sport_cricket_ques2);
            manswer = resources.getStringArray(R.array.sport_cricket_ans2);
