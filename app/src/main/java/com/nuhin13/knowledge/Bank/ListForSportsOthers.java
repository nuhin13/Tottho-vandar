 ...
 */
public class ListForSportsOthers extends Fragment {
    ...
    public static class ContentAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ContentAdapter(Context context) {
            ...
            mquestion = resources.getStringArray(R.array.sports_others_ques);
            manswer = resources.getStringArray(R.array.sports_others_ans);
