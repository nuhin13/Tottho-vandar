 ...
 */
public class ListForIQBuddhi  extends Fragment {
    ...
    public static class ContentAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ContentAdapter(Context context) {
            ...
            mquestion = resources.getStringArray(R.array.id_buddhi_qeues);
            manswer = resources.getStringArray(R.array.id_buddhi_ans);
