...
/**
 * Created by nuhin13 on 10/5/2016.
 */
public class ListForFunnyAbbribiation extends Fragment {
    ...
    public static class ContentAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ContentAdapter(Context context) {
            ...
            mquestion = resources.getStringArray(R.array.funny_fullform_ques);
            manswer = resources.getStringArray(R.array.funny_fullforanswer);
